import asyncio
import pytest
from speconn.context import SpeconnContext, create_context, create_context_from_asgi_scope
...
async def test_context_timeout():
    ...
    with pytest.raises(asyncio.CancelledError, match="timeout"):
...
def test_create_context_from_asgi_scope():
    scope = {
        "type": "http",
    ...
    ctx = create_context_from_asgi_scope(scope, timeout_ms=5000)
